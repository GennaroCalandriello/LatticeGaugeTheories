  ...
  for (int idx = 0; idx < N; idx++) {
...

    {
      ...
      for (int i = 0; i < R; i++) {
        ...
        // U[r+i*a_mu]
        I *= U(U.index(posMod(x + i * a_mu[0], Ns), posMod(y + i * a_mu[1], Ns),
      ...
      for (int j = 0; j < T; j++) {
        ...
        // U[r+j*a_nu+T*a_mu]
        I *= U(U.index(posMod(x + j * a_nu[0] + T * a_mu[0], Ns),
      ...
      for (int i = R - 1; i >= 0; i--) {
        ...
        I *= U(U.index(posMod(x + i * a_mu[0] + R * a_nu[0], Ns),
      ...
      for (int j = T - 1; j >= 0; j--) {
        ...
        // U[r+j*a_nu].conjT()
        I *= U(U.index(posMod(x + j * a_nu[0], Ns), posMod(y + j * a_nu[1], Ns),
